...
## 08 - Rust code to update a post

In bin/publish_post.rs:
...
```sh
cargo run -q --bin publish_post 1
# Published post first

cargo run -q --bin publish_post 2
# Published post second
...
## 09 - Rust code to delete posts matching a string pattern

In bin/delete_posts.rs:
...
```sh
cargo run -q --bin delete_posts first
# Deleted 1 posts
